...
public class ImageStack extends MyObservable {
	...
	public void initFromDirectory(String dir_name) {
		...
		Thread t = new Thread() {
			...
			// checks the DICOM files, retrieves their image number and loads them in the
			// right order.
			public void run() {
				...
				progress_win.setLocation((main_width - progress_win.getSize().width) / 2,
	...
	/**
	 * Sets the currently active image in the viewmode. Notifys Observers with
	 * M_NEW_ACTIVE_IMAGE Message. Object is the new active image value;
	 * 
